...
class Ms8607Node(Node):
    ...
    def __init__(self, bus=1):        
        ...
        super().__init__('ms8607_i2c1')
        self.pressure_publisher_ = self.create_publisher(Float64, '/ms8607_i2c1/pressure', 10)
        self.temperature_publisher_ = self.create_publisher(Float64, '/ms8607_i2c1/temperature', 10)
        self.humidity_publisher_ = self.create_publisher(Float64, '/ms8607_i2c1/humidity', 10)
        timer_period = 0.5
        self.timer = self.create_timer(timer_period, self.timer_callback)
        self.i = 0
        self.get_logger().info("Sensor MS8607 on bus i2c-1 correctly initialized.")
...
def main(args=None):
    ...
    ms8607_i2c1_publisher = Ms8607Node()
    rclpy.spin(ms8607_i2c1_publisher)

    ms8607_i2c1_publisher.destroy_node()
    rclpy.shutdown()
