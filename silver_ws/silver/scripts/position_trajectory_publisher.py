...
class PositionTrajectoryPublisher(Node):

    def __init__(self):
        super().__init__('position_trajectory_publisher')
...
def main(args=None):
    ...
    position_trajectory_publisher = PositionTrajectoryPublisher()

    rclpy.spin(position_trajectory_publisher)

    # Destroy the node explicitly
    # (optional - otherwise it will be done automatically
    # when the garbage collector destroys the node object)
    position_trajectory_publisher.destroy_node()
    rclpy.shutdown()
